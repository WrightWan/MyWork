...
CREATE TABLE RADIOLOGYDATE (ID BIGINT NOT NULL, DATE DATE, radiology_fk VARCHAR(255), PRIMARY KEY (ID))
...
ALTER TABLE RADIOLOGYDATE ADD CONSTRAINT FK_RADIOLOGYDATE_radiology_fk FOREIGN KEY (radiology_fk) REFERENCES TREATMENT (dates)
